    ...
    var body: some View {
        NavigationStack {
            List {
                ...
                Section {
                    Text("""
                         Set up a Shortcuts automation so a tap works with Tim closed: \
                         Shortcuts › Automation › NFC › scan your tag › add the \
                         “\(Vocab.timAction)” action › turn off Ask Before Running.
                         """)
                    .font(.footnote)
                    .foregroundStyle(.secondary)
                } header: {
                    Text("Tapping without opening Tim")
                }

                Section {
                    TextField("https://tim.example.com/tap", text: $linkToWrite)
